...
class Home extends React.Component {
  ...
  render () {
    ...
    const exhibition = (themeConfig.index.exhibition &&
      isObject(themeConfig.index.exhibition) &&
      !isEmpty(themeConfig.index.exhibition)) ? themeConfig.index.exhibition : false;
    return (
